...
namespace SpotifyWebAPI
{
    public class Artist : BaseModel
    {
        ...
        /// <returns></returns>
        public static async Task<Page<Artist>> Search(string artistName,string year = "", string genre = "",string upc = "",string isrc = "", int limit = 20, int offset = 0)
        {
            ...
            var json = await HttpHelper.GetWToken(queryString);
